            ...
            <div className="form">
                ...
                <form ref={formRef} onSubmit={handleSubmit}>
                    <div className="input-container ic1">
                        <input id="firstname" className="input" type="text" name="أسم_العميل" required placeholder="" />
                        <div className="cut"></div>
                        <label htmlFor="firstname" className="placeholder-f">الاسم</label>
                    </div>
                    <div className="input-container ic2">
                        <input id="email" className="input" type="email" name="البريد_الالكتروني" required placeholder="" />
                        <div className="cut"></div>
                        <label htmlFor="email" className="placeholder-f">البريد</label>
                    </div>
                    <div className="input-container ic2">
                        <input id="number" className="input" type="number" name="رقم_الهاتف" required placeholder="" />
                        <div className="cut cut-short"></div>
                        <label htmlFor="number" className="placeholder-f">الجوال</label>
                    </div>
                    <select className="input" name="الباقه_المختاره" value={choice} onChange={handleChoice}>
