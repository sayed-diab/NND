    ...
    useEffect(() => {
        ...
        mm.add("(min-width: 993px)", () => {
            gsap.fromTo(productRef.current,
                { y: -100, opacity: 0 },
                { duration: 2.5, opacity: 1, y: 0, ease: 'bounce.out', delay: 2 }
            );
            gsap.fromTo(logoRef.current,
                { x: -120, opacity: 0 },
                { duration: 2, x: 0, opacity: 1, ease: 'power3.out', delay: 1.2, yoyo: true }
            );
            gsap.fromTo(infoRef.current,
                { x: -70, opacity: 0 },
                { duration: 1.3, x: 0, opacity: 1, ease: 'power3.inOut', yoyo: true }
            );
            gsap.fromTo(descRef.current,
                { x: -60, opacity: 0 },
                { duration: 1.2, x: 0, opacity: 1, ease: 'power3.inOut', yoyo: true }
            );
        ...
        mm.add("(max-width: 768px)", () => {
            ...
            gsap.fromTo(logoRef.current,
                { y: -120, opacity: 0 },
                { duration: 2, y: 0, opacity: 1, ease: 'power3.out', delay: 1.2, yoyo: true }
            );
            gsap.fromTo(infoRef.current,
                { y: -70, opacity: 0 },
                { duration: 1.3, y: 0, opacity: 1, ease: 'power3.inOut', yoyo: true }
            );
            gsap.fromTo(descRef.current,
                { y: -60, opacity: 0 },
                { duration: 1.2, y: 0, opacity: 1, ease: 'power3.inOut', yoyo: true }
            );
            gsap.fromTo(btnRef.current,
                { y: -100, opacity: 0.3 },
        ...
        <main className="container">
            <section className="landing__container">
                ...
                <div className="wrapper__info">
                    <div className="landing__info" ref={infoRef}>
